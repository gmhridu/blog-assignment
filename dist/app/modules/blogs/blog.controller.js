...
const getBlogsByAuthorId = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { authorId } = req.params;
    const result = yield blog_service_1.BlogServices.getBlogsByAuthorId(authorId);
    (0, sendResponse_1.default)(res, {
        status: 200,
        success: true,
